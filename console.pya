...
#       return ret
    ...
    def do_create(self, line):
        """Creates a new instaSON file) and prints the id."""
        if line == '':
...
on the class name and id."""
    ...
    def do_all(self, line):
        """
        Prints all $ all BaseModel or $ all
        """
        args = line.split()
        result = []
        if len(args) != 0:
    ...
    def do_update(self, line):
        """
        Updates an into the JSON file). Ex: $ update
        BaseModel 1234-1234- "aibnb@mail.com".
